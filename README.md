...
| [clase-9-metodologia-top-down/](clase-9-metodologia-top-down/) | Metodología top-down: evaluar de lo general a lo particular (del propósito del todo a los componentes). Cuatro pasos, árbol de evaluación con el caso del laboratorio, contraste con bottom-up, caso aplicado, checkpoint "pensá en top-down", registro para la carpeta y lanzamiento del **Trabajo Práctico N°4** (evaluación comparativa, en Drive) | 13 slides |
